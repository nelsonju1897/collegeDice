...
// Random Die: All potential rolls available ---------------------------------------------------------
		if(result == "13"){
...
//Extra Turn Die. Gain 1 turn but have score minus the result of the roll. ------------------------------
		else if(result == "10"){			
...
//Normal Die. This die has all normal additions. --------------------------------------------------------		
		else if(result == "8"){
...
//Special Die This die contains the four different special die.	------------------------------------------------------	
		else if(result == "4"){
		...
		// 	console.log("The overscore is " + currentPlayerScore)
		// 	currentPlayerScore = 0;
		// 		console.log("then... " + currentPlayerScore)
		// }
	}
	if(currentPlayerScore == 99){
		console.log("You WIN!");
	...
	else if(currentPlayerTurns <= 0  || currentPlayerScore > 99){
		console.log("You lose.");
		let endquestion = prompt("Do you want to play again? Type Yes to restart, type No to quit.");
		if(endquestion == "Yes"){
			runGame();
		}
			else if(endquestion == "No"){
